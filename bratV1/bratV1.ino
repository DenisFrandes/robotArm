...
// Pagina HTML cu slider-uri și afișaj unghiuri
...
<body>
  ...
  <p>Servo 2: <input type="range" min="0" max="180" value="90" class="slider" id="servo2"> <span class="angle" id="angle2">90</span>°</p>
  <p>Servo 3: <input type="range" min="0" max="180" value="90" class="slider" id="servo3"> <span class="angle" id="angle3">90</span>°</p>
  <p>Servo 4: <input type="range" min="0" max="180" value="90" class="slider" id="servo4"> <span class="angle" id="angle4">90</span>°</p>
  <p>Servo 5: <input type="range" min="0" max="360" value="90" class="slider" id="servo5"> <span class="angle" id="angle5">90</span>°</p>
  <p>Servo 6: <input type="range" min="0" max="180" value="90" class="slider" id="servo6"> <span class="angle" id="angle6">90</span>°</p>
  <script>
