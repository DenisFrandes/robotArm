...
void setup() {
  ...
  // Setare poziții inițiale (fără a trece prin 90°)
  servo1.write(servo1Pos); // Servo 1 la 90°
  servo2.write(servo2Pos); // Servo 2 la 100°
  servo3.write(servo3Pos); // Servo 3 la 57°
  servo4.write(servo4Pos); // Servo 4 la 170°
  servo5.write(servo5Pos); // Servo 5 la 90°
  servo6.write(servo6Pos); // Servo 6 la 22°
